function U = bsrTril(A, varargin)
% Extract upper triangular blocks.
%   bsrTriu(A) is the upper triangular part of A.
...
% 
%   See also bsrTril, bsrDiag.

%%#codegen -args {crs_matrix} bsrTriu1 -args {crs_matrix, int32(1)}
...
[U.col_ind, U.val] = crsSort(U.row_ptr, U.col_ind, U.val);
