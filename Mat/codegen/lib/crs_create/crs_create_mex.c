 ...
 * %#m2c options: codegenArgs=-args {coder.typeof(int32(0), [inf,1]), coder.typeof(int32(0), [inf,1]), coder.typeof(0, [inf,1])} crs_create0 -args {int32(0), int32(0)} crs_create1 -args {coder.typeof(int32(0), [inf,1]), coder.typeof(int32(0), [inf,1]), coder.typeof(0, [inf,1]), int32(0), int32(0)}  enableInline=1 withOMP=1
 *
 */
