 ...
 * %#m2c options: codegenArgs=-args {crs_matrix, crs_matrix}  enableInline=1 withOMP=1
 *
 */
...
void crs_prodAB_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    if (mxGetNumberOfFields(prhs[0])!=5)
        mexErrMsgIdAndTxt("crs_prodAB:InputStructWrongFields",
    ...
    *(void **)&C.val = mxCalloc(1, sizeof(emxArray__common));    init_emxArray((emxArray__common*)C.val, 1);
    ...
    mxSetFieldByNumber((mxArray*)(plhs[0]), 0, 4, copy_scalar_to_mxArray(&C.ncols, mxINT32_CLASS));
