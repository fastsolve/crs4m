...
void crs_create(const plcArray_int32_T *rows, const plcArray_int32_T *cols,
                const plcArray_real_T *vs, struct_T *A)
{
  plcArray_int32_T *x;
  int32_T i0;
  int32_T j;
  ...
  if ((rows->size[0] == 1) && (cols->size[0] == 1)) {
    i0 = A->row_ptr->size[0];
    A->row_ptr->size[0] = 0;
    plcEnsureCapacity((plcArray__common *)A->row_ptr, i0, (int32_T)sizeof
                      (int32_T));
    i0 = A->col_ind->size[0];
    A->col_ind->size[0] = 0;
    plcEnsureCapacity((plcArray__common *)A->col_ind, i0, (int32_T)sizeof
                      (int32_T));
    i0 = A->val->size[0];
    A->val->size[0] = vs->size[0];
    plcEnsureCapacity((plcArray__common *)A->val, i0, (int32_T)sizeof(real_T));
    j = vs->size[0];
    for (i0 = 0; i0 < j; i0++) {
    ...
    if (ascend) {
      ...
      plcEnsureCapacity((plcArray__common *)x, i0, (int32_T)sizeof(int32_T));
      j = A->row_ptr->size[0];
      for (i0 = 0; i0 < j; i0++) {
...
void crs_create1(const plcArray_int32_T *is, const plcArray_int32_T *js, const
                 plcArray_real_T *vs, int32_T ni, int32_T nj, struct_T *A)
{
  int32_T i1;
  int32_T i;
  boolean_T ascend;
  ...
  plcEnsureCapacity((plcArray__common *)A->row_ptr, i1, (int32_T)sizeof(int32_T));
  for (i1 = 0; i1 <= ni; i1++) {
    A->row_ptr->data[i1] = 0;
  }
  ...
  if (ascend) {
    ...
    plcEnsureCapacity((plcArray__common *)A->col_ind, i1, (int32_T)sizeof
                      (int32_T));
    j = js->size[0];
    for (i1 = 0; i1 < j; i1++) {
    ...
    i1 = A->val->size[0];
    A->val->size[0] = vs->size[0];
    plcEnsureCapacity((plcArray__common *)A->val, i1, (int32_T)sizeof(real_T));
    j = vs->size[0];
    for (i1 = 0; i1 < j; i1++) {
    ...
    i1 = x->size[0];
    x->size[0] = A->row_ptr->size[0];
    plcEnsureCapacity((plcArray__common *)x, i1, (int32_T)sizeof(int32_T));
    j = A->row_ptr->size[0];
    for (i1 = 0; i1 < j; i1++) {
