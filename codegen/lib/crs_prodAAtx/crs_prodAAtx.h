...
extern void crs_prodAAtx(const struct_T *A, const plcArray_real_T *x, plcArray_real_T *b, plcArray_real_T *Atx, const plcArray_int32_T *nthreads);
extern void crs_prodAAtx_initialize(void);
extern void crs_prodAAtx_mpi(const struct_T *A, const plcArray_real_T *x, plcArray_real_T *b, plcArray_real_T *Atx, const plcArray_int32_T *nthreads, const b_struct_T *comm);
extern void crs_prodAAtx_mpip(const struct_T *A, const plcArray_real_T *x, plcArray_real_T *b, plcArray_real_T *Atx, const plcArray_int32_T *nthreads, const b_struct_T *comm, const plcArray_real_T *pbmsg);
extern void crs_prodAAtx_mpip1(const struct_T *A, const plcArray_real_T *x, plcArray_real_T *b, plcArray_real_T *Atx, const plcArray_int32_T *nthreads, const b_struct_T *comm, const plcArray_real_T *pbmsg, int32_T pbsz);
extern void crs_prodAAtx_ser(const struct_T *A, const plcArray_real_T *x, plcArray_real_T *b);
extern void crs_prodAAtx_ser1(const struct_T *A, const plcArray_real_T *x, plcArray_real_T *b);
