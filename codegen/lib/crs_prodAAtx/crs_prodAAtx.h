...
extern void crs_prodAAtx(const struct_T *A, const emxArray_real_T *x, emxArray_real_T *b, emxArray_real_T *Atx, const emxArray_int32_T *nthreads);
extern void crs_prodAAtx_initialize(void);
extern void crs_prodAAtx_mpi(const struct_T *A, const emxArray_real_T *x, emxArray_real_T *b, emxArray_real_T *Atx, const emxArray_int32_T *nthreads, const b_struct_T *comm);
extern void crs_prodAAtx_mpip(const struct_T *A, const emxArray_real_T *x, emxArray_real_T *b, emxArray_real_T *Atx, const emxArray_int32_T *nthreads, const b_struct_T *comm, const emxArray_real_T *pbmsg);
extern void crs_prodAAtx_mpip1(const struct_T *A, const emxArray_real_T *x, emxArray_real_T *b, emxArray_real_T *Atx, const emxArray_int32_T *nthreads, const b_struct_T *comm, const emxArray_real_T *pbmsg, int32_T pbsz);
extern void crs_prodAAtx_ser(const struct_T *A, const emxArray_real_T *x, emxArray_real_T *b);
extern void crs_prodAAtx_ser1(const struct_T *A, const emxArray_real_T *x, emxArray_real_T *b);
