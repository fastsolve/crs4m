#ifndef __CRS_PRODATAX_H__
#define __CRS_PRODATAX_H__
#include <math.h>
#include <stddef.h>
#include <stdlib.h>
#include <string.h>
...
extern void crs_prodAtAx(const struct_T *A, const emxArray_real_T *x, emxArray_real_T *b, emxArray_real_T *Ax, const emxArray_int32_T *nthreads);
extern void crs_prodAtAx_initialize(void);
extern void crs_prodAtAx_mpi(const struct_T *A, const emxArray_real_T *x, emxArray_real_T *b, emxArray_real_T *Ax, const emxArray_int32_T *nthreads, const b_struct_T *comm);
extern void crs_prodAtAx_mpip(const struct_T *A, const emxArray_real_T *x, emxArray_real_T *b, emxArray_real_T *Ax, const emxArray_int32_T *nthreads, const b_struct_T *comm, const emxArray_real_T *pbmsg);
extern void crs_prodAtAx_mpip1(const struct_T *A, const emxArray_real_T *x, emxArray_real_T *b, emxArray_real_T *Ax, const emxArray_int32_T *nthreads, const b_struct_T *comm, const emxArray_real_T *pbmsg, int32_T pbsz);
extern void crs_prodAtAx_ser(const struct_T *A, const emxArray_real_T *x, emxArray_real_T *b);
extern void crs_prodAtAx_ser1(const struct_T *A, const emxArray_real_T *x, emxArray_real_T *b);
