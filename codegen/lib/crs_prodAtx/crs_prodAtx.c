...
static void d_crs_prodAtx(const m2cArray_int32_T *A_row_ptr, const
  m2cArray_int32_T *A_col_ind, const m2cArray_real_T *A_val, int32_T A_nrows,
  int32_T A_ncols, const m2cArray_real_T *x, m2cArray_real_T *b, const
  m2cArray_int32_T *nthreads, MPI_Comm varargin_1);
static void e_crs_prodAtx(const m2cArray_int32_T *A_row_ptr, const
  m2cArray_int32_T *A_col_ind, const m2cArray_real_T *A_val, int32_T A_nrows,
  int32_T A_ncols, const m2cArray_real_T *x, m2cArray_real_T *b, const
  m2cArray_int32_T *nthreads, MPI_Comm varargin_1, const m2cArray_real_T
  *varargin_2);
static void f_crs_prodAtx(const m2cArray_int32_T *A_row_ptr, const
  m2cArray_int32_T *A_col_ind, const m2cArray_real_T *A_val, int32_T A_nrows,
  int32_T A_ncols, const m2cArray_real_T *x, m2cArray_real_T *b, const
  m2cArray_int32_T *nthreads, MPI_Comm varargin_1, const m2cArray_real_T
...
void crs_prodAtx(const struct_T *A, const m2cArray_real_T *x, m2cArray_real_T *b,
...
void crs_prodAtx_mpi(const struct_T *A, const m2cArray_real_T *x,
...
void crs_prodAtx_mpip(const struct_T *A, const m2cArray_real_T *x,
...
void crs_prodAtx_mpip1(const struct_T *A, const m2cArray_real_T *x,
  m2cArray_real_T *b, const m2cArray_int32_T *nthreads, const b_struct_T *comm,
  const m2cArray_real_T *pbmsg, int32_T pbsz)
{
  boolean_T p;
  boolean_T b_p;
  int32_T k;
...
void crs_prodAtx_ser(const struct_T *A, const m2cArray_real_T *x,
                     m2cArray_real_T *b)
{
  b_crs_prodAtx(A->row_ptr, A->col_ind, A->val, A->nrows, A->ncols, x, b);
}

void crs_prodAtx_ser1(const struct_T *A, const m2cArray_real_T *x,
                      m2cArray_real_T *b)
{
