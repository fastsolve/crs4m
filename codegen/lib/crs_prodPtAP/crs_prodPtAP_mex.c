...
void crs_prodPtAP_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void**)&P.row_ptr = mxCalloc(1, sizeof(plcArray__common));
    alias_mxArray_to_plcArray(_sub_mx1, (plcArray__common*)P.row_ptr, "P.row_ptr", 1);
    ...
    *(void**)&P.col_ind = mxCalloc(1, sizeof(plcArray__common));
    alias_mxArray_to_plcArray(_sub_mx1, (plcArray__common*)P.col_ind, "P.col_ind", 1);
    ...
    *(void**)&P.val = mxCalloc(1, sizeof(plcArray__common));
    alias_mxArray_to_plcArray(_sub_mx1, (plcArray__common*)P.val, "P.val", 1);
    ...
    *(void **)&B.row_ptr = mxCalloc(1, sizeof(plcArray__common));    init_plcArray( (plcArray__common*)B.row_ptr, 1);
    *(void **)&B.col_ind = mxCalloc(1, sizeof(plcArray__common));    init_plcArray( (plcArray__common*)B.col_ind, 1);
    *(void **)&B.val = mxCalloc(1, sizeof(plcArray__common));    init_plcArray( (plcArray__common*)B.val, 1);
    ...
    mxSetFieldByNumber( (mxArray*)(plhs[0]), 0, 0, move_plcArray_to_mxArray((plcArray__common*)B.row_ptr, mxINT32_CLASS));
    mxSetFieldByNumber( (mxArray*)(plhs[0]), 0, 1, move_plcArray_to_mxArray((plcArray__common*)B.col_ind, mxINT32_CLASS));
    mxSetFieldByNumber( (mxArray*)(plhs[0]), 0, 2, move_plcArray_to_mxArray((plcArray__common*)B.val, mxDOUBLE_CLASS));
    ...
    free_plcArray( (plcArray__common*)P.val); mxFree( P.val);
    free_plcArray( (plcArray__common*)P.col_ind); mxFree( P.col_ind);
    free_plcArray( (plcArray__common*)P.row_ptr); mxFree( P.row_ptr);
