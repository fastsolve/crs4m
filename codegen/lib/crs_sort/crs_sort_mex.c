...
void crs_sort_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    alias_mxArray_to_plcArray(plhs[0], (plcArray__common *)&col_ind, "col_ind", 1);
    ...
    alias_mxArray_to_plcArray(plhs[1], (plcArray__common *)&val, "val", 1);
    ...
    if (col_ind.canFreeData) plhs[1] = move_plcArray_to_mxArray((plcArray__common*)&col_ind, mxINT32_CLASS);
    if (val.canFreeData) plhs[2] = move_plcArray_to_mxArray((plcArray__common*)&val, mxDOUBLE_CLASS);    /* Free temporary variables */
    free_plcArray( (plcArray__common*)&row_ptr);
    free_plcArray( (plcArray__common*)&col_ind);
    free_plcArray( (plcArray__common*)&val);}
...
void crs_sort0_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    crs_sort_terminate();
    /* Marshall out function outputs */
    if (col_ind.canFreeData) plhs[1] = move_plcArray_to_mxArray((plcArray__common*)&col_ind, mxINT32_CLASS);    /* Free temporary variables */
    free_plcArray( (plcArray__common*)&row_ptr);
    free_plcArray( (plcArray__common*)&col_ind);}
