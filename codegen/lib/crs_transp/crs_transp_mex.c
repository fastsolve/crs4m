...
void crs_transp_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&At.row_ptr = mxCalloc(1, sizeof(emxArray__common));    init_emxArray( (emxArray__common*)At.row_ptr, 1);
    *(void **)&At.col_ind = mxCalloc(1, sizeof(emxArray__common));    init_emxArray( (emxArray__common*)At.col_ind, 1);
    *(void **)&At.val = mxCalloc(1, sizeof(emxArray__common));    init_emxArray( (emxArray__common*)At.val, 1);
    ...
    mxSetFieldByNumber( (mxArray*)(plhs[0]), 0, 0, move_emxArray_to_mxArray((emxArray__common*)At.row_ptr, mxINT32_CLASS));
    mxSetFieldByNumber( (mxArray*)(plhs[0]), 0, 1, move_emxArray_to_mxArray((emxArray__common*)At.col_ind, mxINT32_CLASS));
    mxSetFieldByNumber( (mxArray*)(plhs[0]), 0, 2, move_emxArray_to_mxArray((emxArray__common*)At.val, mxDOUBLE_CLASS));
    ...
    free_emxArray( (emxArray__common*)At.val); mxFree( At.val);
    free_emxArray( (emxArray__common*)At.col_ind); mxFree( At.col_ind);
    free_emxArray( (emxArray__common*)At.row_ptr); mxFree( At.row_ptr);
}
