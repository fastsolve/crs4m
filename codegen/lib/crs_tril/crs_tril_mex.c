...
void crs_tril_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&L.row_ptr = mxCalloc(1, sizeof(plcArray__common));    init_plcArray( (plcArray__common*)L.row_ptr, 1);
    *(void **)&L.col_ind = mxCalloc(1, sizeof(plcArray__common));    init_plcArray( (plcArray__common*)L.col_ind, 1);
    *(void **)&L.val = mxCalloc(1, sizeof(plcArray__common));    init_plcArray( (plcArray__common*)L.val, 1);
    ...
    mxSetFieldByNumber( (mxArray*)(plhs[0]), 0, 0, move_plcArray_to_mxArray((plcArray__common*)L.row_ptr, mxINT32_CLASS));
    mxSetFieldByNumber( (mxArray*)(plhs[0]), 0, 1, move_plcArray_to_mxArray((plcArray__common*)L.col_ind, mxINT32_CLASS));
    mxSetFieldByNumber( (mxArray*)(plhs[0]), 0, 2, move_plcArray_to_mxArray((plcArray__common*)L.val, mxDOUBLE_CLASS));
    ...
    free_plcArray( (plcArray__common*)L.val); mxFree( L.val);
    free_plcArray( (plcArray__common*)L.col_ind); mxFree( L.col_ind);
    free_plcArray( (plcArray__common*)L.row_ptr); mxFree( L.row_ptr);
}
