...
void crs_triu_api(const mxArray ** prhs, const mxArray **plhs) {
    ...
    *(void **)&U.row_ptr = mxCalloc(1, sizeof(plcArray__common));    init_plcArray( (plcArray__common*)U.row_ptr, 1);
    *(void **)&U.col_ind = mxCalloc(1, sizeof(plcArray__common));    init_plcArray( (plcArray__common*)U.col_ind, 1);
    *(void **)&U.val = mxCalloc(1, sizeof(plcArray__common));    init_plcArray( (plcArray__common*)U.val, 1);
    ...
    mxSetFieldByNumber( (mxArray*)(plhs[0]), 0, 0, move_plcArray_to_mxArray((plcArray__common*)U.row_ptr, mxINT32_CLASS));
    mxSetFieldByNumber( (mxArray*)(plhs[0]), 0, 1, move_plcArray_to_mxArray((plcArray__common*)U.col_ind, mxINT32_CLASS));
    mxSetFieldByNumber( (mxArray*)(plhs[0]), 0, 2, move_plcArray_to_mxArray((plcArray__common*)U.val, mxDOUBLE_CLASS));
    ...
    free_plcArray( (plcArray__common*)U.val); mxFree( U.val);
    free_plcArray( (plcArray__common*)U.col_ind); mxFree( U.col_ind);
    free_plcArray( (plcArray__common*)U.row_ptr); mxFree( U.row_ptr);
}
