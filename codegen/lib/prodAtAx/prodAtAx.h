...
extern void prodAtAx(const emxArray_real_T *A, const emxArray_real_T *x,
                     emxArray_real_T *b, emxArray_real_T *Ax, const
                     emxArray_int32_T *nthreads);
extern void prodAtAx_initialize(void);
extern void prodAtAx_ser(const emxArray_real_T *A, const emxArray_real_T *x,
  emxArray_real_T *b);
extern void prodAtAx_ser1(const emxArray_real_T *A, const emxArray_real_T *x,
  emxArray_real_T *b);
