...
int cuBlasGetEnum(const emxArray_char_T *str)
{
  ...
  int exitg8;
  static const char cv2[21] = { 'C', 'U', 'B', 'L', 'A', 'S', '_', 'S', 'T', 'A',
    'T', 'U', 'S', '_', 'S', 'U', 'C', 'C', 'E', 'S', 'S' };

  int exitg7;
  static const char cv3[29] = { 'C', 'U', 'B', 'L', 'A', 'S', '_', 'S', 'T', 'A',
    'T', 'U', 'S', '_', 'N', 'O', 'T', '_', 'I', 'N', 'I', 'T', 'I', 'A', 'L',
    'I', 'Z', 'E', 'D' };

  int exitg6;
  static const char cv4[26] = { 'C', 'U', 'B', 'L', 'A', 'S', '_', 'S', 'T', 'A',
  ...
  int exitg4;
  static const char cv6[27] = { 'C', 'U', 'B', 'L', 'A', 'S', '_', 'S', 'T', 'A',
  ...
  int exitg2;
  static const char cv8[30] = { 'C', 'U', 'B', 'L', 'A', 'S', '_', 'S', 'T', 'A',
    'T', 'U', 'S', '_', 'E', 'X', 'E', 'C', 'U', 'T', 'I', 'O', 'N', '_', 'F',
    'A', 'I', 'L', 'E', 'D' };

  int exitg1;
  static const char cv9[28] = { 'C', 'U', 'B', 'L', 'A', 'S', '_', 'S', 'T', 'A',
