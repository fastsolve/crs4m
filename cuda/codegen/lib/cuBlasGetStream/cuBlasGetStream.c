...
void cuBlasGetStream(const struct0_T *cubHdl, struct0_T *strm, int32_T *errCode,
                     boolean_T *toplevel)
{
  cudaStream_t t_strm;
  boolean_T p;
  ...
  *toplevel = true;
  ...
  if (!p) {
    ...
    emxEnsureCapacity((emxArray__common *)b_cubHdl, varargin_2, (int32_T)sizeof
                      (char_T));
  ...
  emxEnsureCapacity((emxArray__common *)data0, varargin_2, (int32_T)sizeof
                    (uint8_T));
  ...
  *errCode = cublasGetStream(hdl, &t_strm);
  ...
  emxEnsureCapacity((emxArray__common *)strm->data, varargin_2, (int32_T)sizeof
                    (uint8_T));
  k = data0->size[0];
  for (varargin_2 = 0; varargin_2 < k; varargin_2++) {
  ...
  strm->type->size[0] = 1;
  strm->type->size[1] = 12;
  emxEnsureCapacity((emxArray__common *)strm->type, varargin_2, (int32_T)sizeof
                    (char_T));
  for (varargin_2 = 0; varargin_2 < 12; varargin_2++) {
