...
void cuMatCopySubFromGPU(int32_T nrows, int32_T ncols, const struct0_T *cuMat,
  const emxArray_real_T *mat, int32_T *errCode, boolean_T *toplevel)
{
  int32_T sizepe;
  uint64_T data;
  void * output;
...
void cuMatCopySubFromGPU_async(int32_T nrows, int32_T ncols, const struct0_T
  *cuMat, const emxArray_real_T *mat, const struct1_T *strm, int32_T *errCode,
  boolean_T *toplevel)
{
  int32_T sizepe;
  uint64_T data;
