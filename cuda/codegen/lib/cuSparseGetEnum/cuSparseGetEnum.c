...
int cuSparseGetEnum(const emxArray_char_T *str)
{
  ...
  int exitg24;
  static const char cv2[27] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_', 'D',
    'I', 'A', 'G', '_', 'T', 'Y', 'P', 'E', '_', 'N', 'O', 'N', '_', 'U', 'N',
    'I', 'T' };

  int exitg23;
  static const char cv3[23] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_', 'D',
    'I', 'A', 'G', '_', 'T', 'Y', 'P', 'E', '_', 'U', 'N', 'I', 'T' };

  int exitg22;
  static const char cv4[24] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_', 'F',
    'I', 'L', 'L', '_', 'M', 'O', 'D', 'E', '_', 'L', 'O', 'W', 'E', 'R' };

  int exitg21;
  static const char cv5[24] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_', 'F',
    'I', 'L', 'L', '_', 'M', 'O', 'D', 'E', '_', 'U', 'P', 'P', 'E', 'R' };

  int exitg20;
  static const char cv6[24] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_', 'I',
    'N', 'D', 'E', 'X', '_', 'B', 'A', 'S', 'E', '_', 'Z', 'E', 'R', 'O' };

  int exitg19;
  static const char cv7[23] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_', 'I',
    'N', 'D', 'E', 'X', '_', 'B', 'A', 'S', 'E', '_', 'O', 'N', 'E' };

  int exitg18;
  static const char cv8[28] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_', 'M',
    'A', 'T', 'R', 'I', 'X', '_', 'T', 'Y', 'P', 'E', '_', 'G', 'E', 'N', 'E',
    'R', 'A', 'L' };

  int exitg17;
  static const char cv9[30] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_', 'M',
    'A', 'T', 'R', 'I', 'X', '_', 'T', 'Y', 'P', 'E', '_', 'S', 'Y', 'M', 'M',
    'E', 'T', 'R', 'I', 'C' };

  int exitg16;
  static const char cv10[30] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'M', 'A', 'T', 'R', 'I', 'X', '_', 'T', 'Y', 'P', 'E', '_', 'H', 'E', 'R',
    'M', 'I', 'T', 'I', 'A', 'N' };

  int exitg15;
  static const char cv11[31] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'M', 'A', 'T', 'R', 'I', 'X', '_', 'T', 'Y', 'P', 'E', '_', 'T', 'R', 'I',
    'A', 'N', 'G', 'U', 'L', 'A', 'R' };

  int exitg14;
  static const char cv12[22] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'D', 'I', 'R', 'E', 'C', 'T', 'I', 'O', 'N', '_', 'R', 'O', 'W' };

  int exitg13;
  static const char cv13[25] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'D', 'I', 'R', 'E', 'C', 'T', 'I', 'O', 'N', '_', 'C', 'O', 'L', 'U', 'M',
    'N' };

  int exitg12;
  static const char cv14[32] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'O', 'P', 'E', 'R', 'A', 'T', 'I', 'O', 'N', '_', 'N', 'O', 'N', '_', 'T',
    'R', 'A', 'N', 'S', 'P', 'O', 'S', 'E' };

  int exitg11;
  static const char cv15[28] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'O', 'P', 'E', 'R', 'A', 'T', 'I', 'O', 'N', '_', 'T', 'R', 'A', 'N', 'S',
    'P', 'O', 'S', 'E' };

  int exitg10;
  static const char cv16[38] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'O', 'P', 'E', 'R', 'A', 'T', 'I', 'O', 'N', '_', 'C', 'O', 'N', 'J', 'U',
    'G', 'A', 'T', 'E', '_', 'T', 'R', 'A', 'N', 'S', 'P', 'O', 'S', 'E' };

  int exitg9;
  static const char cv17[23] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'S', 'U', 'C', 'C', 'E', 'S', 'S' };

  int exitg8;
  static const char cv18[31] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'N', 'O', 'T', '_', 'I', 'N', 'I', 'T',
    'I', 'A', 'L', 'I', 'Z', 'E', 'D' };

  int exitg7;
  static const char cv19[28] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'A', 'L', 'L', 'O', 'C', '_', 'F', 'A',
    'I', 'L', 'E', 'D' };

  int exitg6;
  static const char cv20[29] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'I', 'N', 'V', 'A', 'L', 'I', 'D', '_',
    'V', 'A', 'L', 'U', 'E' };

  int exitg5;
  static const char cv21[29] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'A', 'R', 'C', 'H', '_', 'M', 'I', 'S',
    'M', 'A', 'T', 'C', 'H' };

  int exitg4;
  static const char cv22[29] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'M', 'A', 'P', 'P', 'I', 'N', 'G', '_',
    'E', 'R', 'R', 'O', 'R' };

  int exitg3;
  static const char cv23[32] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'E', 'X', 'E', 'C', 'U', 'T', 'I', 'O',
    'N', '_', 'F', 'A', 'I', 'L', 'E', 'D' };

  int exitg2;
  static const char cv24[30] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'I', 'N', 'T', 'E', 'R', 'N', 'A', 'L',
    '_', 'E', 'R', 'R', 'O', 'R' };

  int exitg1;
  static const char cv25[41] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
