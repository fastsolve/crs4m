...
void cuSparseSetStream(const struct0_T *hdl, const struct0_T *strm, int *errCode,
  boolean_T *toplevel)
{
  boolean_T p;
  boolean_T b_p;
  ...
  static const char cv3[24] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_', 'S',
    'T', 'A', 'T', 'U', 'S', '_', 'S', 'U', 'C', 'C', 'E', 'S', 'S', '\x00' };

  static const char cv4[32] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_', 'S',
  ...
  static const char cv8[30] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_', 'S',
    'T', 'A', 'T', 'U', 'S', '_', 'M', 'A', 'P', 'P', 'I', 'N', 'G', '_', 'E',
    'R', 'R', 'O', 'R', '\x00' };

  static const char cv9[33] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_', 'S',
    'T', 'A', 'T', 'U', 'S', '_', 'E', 'X', 'E', 'C', 'U', 'T', 'I', 'O', 'N',
    '_', 'F', 'A', 'I', 'L', 'E', 'D', '\x00' };

  static const char cv10[31] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'I', 'N', 'T', 'E', 'R', 'N', 'A', 'L',
    '_', 'E', 'R', 'R', 'O', 'R', '\x00' };

  static const char cv11[42] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
