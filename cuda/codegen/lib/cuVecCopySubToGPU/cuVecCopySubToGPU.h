...
extern void cuVecCopySubToGPU(int32_T n, const emxArray_real_T *vec, int32_T
  istart, int32_T inc, const struct0_T *cuVec, int32_T incCuVec, int32_T
  *errCode, boolean_T *toplevel);
extern void cuVecCopySubToGPU_async(int32_T n, const emxArray_real_T *vec,
  int32_T istart, int32_T inc, const struct0_T *cuVec, int32_T incCuVec, const
