#include "cudaMatCopySubFromHost.h"
#include "mspack.h"
#include "m2c.h"
...
static void m2c_error(void)
{
  M2C_error("cudaMatCopyFromHost:TypeMismatch",
            "Real and complex numbers mismatch.");
}

void cudaMatCopySubFromHost(int nrows, int ncols, const emxArray_real_T *mat,
...
void cudaMatCopySubFromHost_initialize(void)
{
}

void cudaMatCopySubFromHost_terminate(void)
{
}
