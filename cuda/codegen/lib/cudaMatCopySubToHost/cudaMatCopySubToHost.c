...
void cudaMatCopySubToHost(int nrows, int ncols, const struct0_T *cuMat, const
...
void cudaMatCopySubToHost_initialize(void)
{
}

void cudaMatCopySubToHost_terminate(void)
{
}
