...
void cudaVecCopyFromHost(const emxArray_real_T *vec, const struct0_T *cuVec, int
  *errCode, boolean_T *toplevel)
{
  ...
  output = *(void **)(data);
  *errCode = cublasSetVector(n, sizepe, ptr, 1, output, 1);
  if (*errCode != 0) {
    i = (CUBLAS_STATUS_SUCCESS);
    n = (CUBLAS_STATUS_NOT_INITIALIZED);
...
void cudaVecCopyFromHost_initialize(void)
{
}

void cudaVecCopyFromHost_terminate(void)
{
}
