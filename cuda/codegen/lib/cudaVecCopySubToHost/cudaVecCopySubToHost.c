...
void cudaVecCopySubToHost(int n, const struct0_T *cuVec, int incCuVec, const
...
void cudaVecCopySubToHost_initialize(void)
{
}

void cudaVecCopySubToHost_terminate(void)
{
}
