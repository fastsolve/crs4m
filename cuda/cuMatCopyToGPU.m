...
% to cuMat on CUDA.
%
% cuMatCopyToGPU(mat, cuMat, cuStream) copies the whole array from mat 
% in MATLAB to cuMat on CUDA. It is important for user to 
% ensure mat is not changed or deallocated before calling
...
if nargin==1
    type = mspType(class(mat), isreal(mat));
