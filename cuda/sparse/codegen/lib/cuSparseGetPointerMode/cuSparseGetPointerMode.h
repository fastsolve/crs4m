#ifndef CUSPARSEGETPOINTERMODE_H
#define CUSPARSEGETPOINTERMODE_H
#include <stddef.h>
#include <stdlib.h>
#include <string.h>
#include "rtwtypes.h"
#include "cuSparseGetPointerMode_types.h"

extern void cuSparseGetPointerMode(const struct0_T *hdl, int32_T *mode, int32_T *
  errCode, boolean_T *toplevel);
extern void cuSparseGetPointerMode_initialize(void);
extern void cuSparseGetPointerMode_terminate(void);
