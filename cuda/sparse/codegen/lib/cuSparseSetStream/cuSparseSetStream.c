...
static void c_m2c_error(const emxArray_char_T *varargin_3)
{
  ...
  M2C_error("cuSparse:RuntimeError",
            "cusparseSetStream returned error code %s\n", &b_varargin_3->data[0]);
  emxFree_char_T(&b_varargin_3);
}
...
void cuSparseSetStream(const struct0_T *hdl, const struct0_T *strm, int32_T
  *errCode, boolean_T *toplevel)
{
  ...
  static const char_T cv3[24] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'S', 'U', 'C', 'C', 'E', 'S', 'S', '\x00'
  };

  static const char_T cv4[32] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'N', 'O', 'T', '_', 'I', 'N', 'I', 'T',
    'I', 'A', 'L', 'I', 'Z', 'E', 'D', '\x00' };

  static const char_T cv5[29] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
  ...
  static const char_T cv8[30] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'M', 'A', 'P', 'P', 'I', 'N', 'G', '_',
    'E', 'R', 'R', 'O', 'R', '\x00' };

  static const char_T cv9[33] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'E', 'X', 'E', 'C', 'U', 'T', 'I', 'O',
    'N', '_', 'F', 'A', 'I', 'L', 'E', 'D', '\x00' };

  static const char_T cv10[31] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
    'S', 'T', 'A', 'T', 'U', 'S', '_', 'I', 'N', 'T', 'E', 'R', 'N', 'A', 'L',
    '_', 'E', 'R', 'R', 'O', 'R', '\x00' };

  static const char_T cv11[42] = { 'C', 'U', 'S', 'P', 'A', 'R', 'S', 'E', '_',
  ...
  *errCode = cusparseSetStream(c_hdl, d_hdl);
  *toplevel = true;
    ...
    switch (k) {
     ...
     case 8:
      ...
      for (varargin_2 = 0; varargin_2 < 42; varargin_2++) {
        cstr->data[varargin_2] = cv11[varargin_2];
      }
      break;
...
void cuSparseSetStream_initialize(void)
{
}

void cuSparseSetStream_terminate(void)
{
}
